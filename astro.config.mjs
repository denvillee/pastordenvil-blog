...
/* The card studio is noindex and stays out of the sitemap. Match the path exactly:
   a substring test would also swallow a future /essays/kitchen-table-theology/. */
const excluded = new Set(['/kit/']);
